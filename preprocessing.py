...
# Loads the data, performs a train test split and sets up encoders and resamplers.
def preprocess_data(csv_path, cols_to_load, seed):
    ...
    # k_neighbors is set to 1, so it can run on the synthetic data, for the real data it was set to the default value 5.
    smote = SMOTENC(random_state=seed, k_neighbors=1, categorical_features=categorical_indices)
