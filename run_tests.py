...
grid_base_dt = dt.fit(base_pipeline_dt, train_data, train_labels, dt.new_param_grid)
...
metrics.score(test_labels, predictions_base_dt)
dt.plot_dt(grid_base_dt, "./output/grid_base_dt.png")
...
metrics.score(test_labels, predictions_base_ccp)
dt.plot_dt(grid_base_ccp, "./output/grid_base_ccp.png")


print("Starting DT Training with SMOTE...")
grid_smote_dt = dt.fit(smote_pipeline_dt, train_data, train_labels, dt.new_param_grid)
...
metrics.score(test_labels, predictions_smote_dt)
dt.plot_dt(grid_smote_dt, "./output/grid_smote_dt.png")
...
print("Results after pruning:")
metrics.score(test_labels, predictions_smote_ccp)
dt.plot_dt(grid_smote_ccp, "./output/grid_smote_ccp.png")


print("Starting SMOTEENN DT Training...")
grid_smote_enn_dt = dt.fit(smote_enn_pipeline_dt, train_data, train_labels, dt.new_param_grid)
...
metrics.score(test_labels, predictions_smote_enn_dt)
dt.plot_dt(grid_smote_enn_dt, "./output/grid_smote_enn_dt.png")
...
print("Results after pruning:")
metrics.score(test_labels, predictions_smote_enn_ccp)
dt.plot_dt(grid_smote_enn_ccp, "./output/grid_smote_enn_ccp.png")


print("Starting SMOTETOMEK DT Training...")
grid_smote_tomek_dt = dt.fit(smote_tomek_pipeline_dt, train_data, train_labels, dt.new_param_grid)
...
metrics.score(test_labels, predictions_smote_tomek_dt)
dt.plot_dt(grid_smote_tomek_dt, "./output/grid_smote_tomek_dt.png")
...
print("Results after pruning:")
metrics.score(test_labels, predictions_smote_tomek_ccp)
dt.plot_dt(grid_smote_tomek_ccp, "./output/grid_smote_tomek_ccp.png")


print("Starting ROSTOMEK DT Training...")
grid_ros_tomek_dt = dt.fit(ros_tomek_pipeline_dt, train_data, train_labels, dt.new_param_grid)
...
metrics.score(test_labels, predictions_ros_tomek_dt)
dt.plot_dt(grid_ros_tomek_dt, "./output/grid_ros_tomek_dt.png")
...
print("Results after pruning:")
metrics.score(test_labels, predictions_ros_tomek_ccp)
dt.plot_dt(grid_ros_tomek_ccp, "./output/grid_ros_tomek_ccp.png")
